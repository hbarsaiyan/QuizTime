...
ADD
    PRIMARY KEY (`pid`),
ADD
    KEY `proctor_email_index` (`email`),
ADD
    KEY `proctor_email_test_id_index` (`email`, `test_id`),
ADD
    KEY `uid` (`uid`);
...
--
ALTER TABLE
    `longqa` MODIFY `longqa_qid` bigint(20) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `longtest`
--
ALTER TABLE
    `longtest` MODIFY `longtest_qid` bigint(20) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `practicalqa`
--
ALTER TABLE
    `practicalqa` MODIFY `pracqa_qid` bigint(20) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `practicaltest`
--
ALTER TABLE
    `practicaltest` MODIFY `pid` bigint(20) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `proctoring_log`
--
ALTER TABLE
    `proctoring_log` MODIFY `pid` bigint(20) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `questions`
--
ALTER TABLE
    `questions` MODIFY `questions_uid` bigint(20) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `students`
--
ALTER TABLE
    `students` MODIFY `sid` bigint(20) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `studenttestinfo`
--
ALTER TABLE
    `studenttestinfo` MODIFY `stiid` bigint(20) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `teachers`
--
ALTER TABLE
    `teachers` MODIFY `tid` bigint(20) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `users`
--
ALTER TABLE
    `users` MODIFY `uid` bigint(20) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `window_estimation_log`
--
ALTER TABLE
    `window_estimation_log` MODIFY `wid` bigint(20) NOT NULL AUTO_INCREMENT;
...
ALTER TABLE
    `longqa`
ADD
    CONSTRAINT `longqa_ibfk_1` FOREIGN KEY (`uid`) REFERENCES `users` (`uid`);
...
ADD
    CONSTRAINT `practicaltest_ibfk_2` FOREIGN KEY (`uid`) REFERENCES `users` (`uid`);
